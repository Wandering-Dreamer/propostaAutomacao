...
section_excel = doc.sections[0]

section_excel.left_margin = Inches(0.75)
section_excel.right_margin = Inches(0.75)
section_excel.top_margin = Inches(1)
section_excel.bottom_margin = Inches(1)

writer = pd.ExcelWriter("Cotação.xlsx") 
...
wb_col = load_workbook("Cotação.xlsx")
sheet = wb_col.active
...
wb_col.save("Cotação.xlsx")


wb_style = load_workbook('Cotação.xlsx')
